...
define("ROOT", __DIR__);
//获取用户信息脚本
require_once ROOT.'/spider/user.php';
require_once ROOT.'/function.php';
require_once ROOT.'/spider/curl.php';
require_once ROOT.'/spider/pdo_mysql.php';
require_once ROOT.'/spider/predis.php';
require_once ROOT.'/spider/log.php';
